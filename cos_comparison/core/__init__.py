...
def _load_backend(module_name: str) -> bool:
    ...
    try:
        ...
        # backends without recompiling compiled extensions.
        ...
        # Normalize `no_done` across backends: the compiled pydll backend
        # ships a C builtin that rejects keyword arguments while the pure
        # Python / ctypes placeholders accept (*args, **kwargs). Replace it
        # with the pure Python placeholder so behaviour is identical on
        # every backend (parity guarantee).
